...
$checks = array(
 ...
 'release version is 0.48.2' => ($health['versions']['release'] ?? null) === '0.48.2',
 'plugin header is 0.48.2' => ($health['versions']['pluginHeader'] ?? null) === '0.48.2',
 'manifest release is 0.48.2' => ($health['versions']['manifestRelease'] ?? null) === '0.48.2',
