...
$checks = array(
    ...
    'release version is 0.48.1' => ($health['versions']['release'] ?? null) === '0.48.1',
    'feature release is 0.48.1' => ($health['versions']['featureRelease'] ?? null) === '0.48.1',
    'plugin header is 0.48.1' => ($health['versions']['pluginHeader'] ?? null) === '0.48.1',
    'manifest release is 0.48.1' => ($health['versions']['manifestRelease'] ?? null) === '0.48.1',
