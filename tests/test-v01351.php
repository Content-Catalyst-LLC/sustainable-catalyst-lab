...
must(strpos($plugin,'Version: 0.135.1')!==false,'plugin header identifies v0.135.1');
...
must(strpos($template,'EXPERIENCE v0.135.1')!==false,'Graph Studio header exposes v0.135.1 experience identity');
