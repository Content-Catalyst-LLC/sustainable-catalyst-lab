...
$checks = array(
 ...
 'release version is 0.48.3' => ($health['versions']['release'] ?? null) === '0.48.3',
 'plugin header is 0.48.3' => ($health['versions']['pluginHeader'] ?? null) === '0.48.3',
 'manifest release is 0.48.3' => ($health['versions']['manifestRelease'] ?? null) === '0.48.3',
