...
ok_render(substr_count($html, 'data-lab-module=') >= 15, 'Expected 15 module panels');
ok_render(substr_count($html, 'data-lab-module-button=') >= 15, 'Expected grouped module buttons');
ok_render(substr_count($html, 'data-quick-tool=') >= 9, 'Expected quick scientific tools');
