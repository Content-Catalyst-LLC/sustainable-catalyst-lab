...
ok_render(substr_count($html, 'data-lab-module=') >= 19, 'Expected at least 18 module panels');
ok_render(substr_count($html, 'data-lab-module-button=') >= 19, 'Expected grouped module buttons');
...
ok_render(strpos($html, 'v0.7.0') !== false, 'Rendered version is incorrect');
