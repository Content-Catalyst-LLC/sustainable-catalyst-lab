...
ok_render(substr_count($html, 'data-lab-module=') >= 18, 'Expected at least 18 module panels');
ok_render(substr_count($html, 'data-lab-module-button=') >= 18, 'Expected grouped module buttons');
...
ok_render(strpos($html, 'v0.6.0') !== false, 'Rendered version is incorrect');
