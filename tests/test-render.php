...
ok_render(substr_count($html, 'data-lab-module=') >= 16, 'Expected 15 module panels');
ok_render(substr_count($html, 'data-lab-module-button=') >= 16, 'Expected grouped module buttons');
ok_render(substr_count($html, 'data-quick-tool=') >= 12, 'Expected quick scientific tools');
