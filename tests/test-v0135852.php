...
need(strpos($main,'Version: 0.135.8.5.3')!==false,'plugin version');
need(strpos($js,"VERSION='0.135.8.5.3'")!==false,'native JS version');
...
echo "PASS - Lab v0.135.8.5.3 incremental provenance interaction contract\n";
