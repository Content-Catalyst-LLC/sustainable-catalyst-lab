...
$checks = array(
 ...
 'release version is 0.51.0' => ($health['versions']['release'] ?? null) === '0.51.0',
 'plugin header is 0.51.0' => ($health['versions']['pluginHeader'] ?? null) === '0.51.0',
 'manifest release is 0.51.0' => ($health['versions']['manifestRelease'] ?? null) === '0.51.0',
