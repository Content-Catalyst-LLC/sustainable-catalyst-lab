...
## Earth systems analysis flow

```text
Observation, map, dataset, or field record
...
→ Earth-specific project collection
...
Version 0.8.0 retains all earlier collections and adds:
...
oceanRecords
marineSystemRecords
remoteSensingRecords
hazardRecords
carbonCycleRecords
earthValidationRecords
```
