...
def main():
 ...
 with zipfile.ZipFile(a.zip_path) as z:
  ...
  if m.get('releaseVersion')!='0.107.0': raise SystemExit('ERROR: releaseVersion is not 0.107.0')
  ...
  print('PASS: releaseVersion=0.107.0')
  print('PASS: Platform Core minimum release=3.0.0')
  print('PASS: scientific execution lineage version=0.107.0')
