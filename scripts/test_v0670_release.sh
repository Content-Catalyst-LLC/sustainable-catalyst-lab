...
echo "==> v0.67.0 Causal Inference & Quasi-Experimental Methods regression gate"
...
php tests/test-v0670.php
php tests/test-v0670-integrity-runtime.php
...
print('PASS - v0.67.0 causal inference + inherited argumentation/evidence-grading/synthesis/literature/claims/study/beta routes wired')
PY
"$PYTHON_BIN" - <<'PY'
from pathlib import Path
import hashlib,json
m=json.loads(Path('build/sc-lab-release-manifest.json').read_text())
assert m['releaseVersion']=='0.67.0';assert m['featureVersion']=='0.67.0';assert m['platformVersion']=='1.0.0'
errors=[]
...
PY
echo "PASS - Lab v0.67.0 Causal Inference & Quasi-Experimental Methods release gate"
