...
def main():
 ...
 with zipfile.ZipFile(a.zip_path) as z:
  ...
  if m.get('releaseVersion')!='0.114.0': raise SystemExit('ERROR: releaseVersion is not 0.114.0')
  if m.get('scientificVisualizationDesignSystemVersion')!='0.114.0': raise SystemExit('ERROR: design-system version mismatch')
  ...
  print('PASS: WordPress ZIP integrity'); print('PASS: releaseVersion=0.114.0'); print('PASS: scientific visualization design system=0.114.0'); print(f'PASS: verifiedFileCount={len(critical)}')
