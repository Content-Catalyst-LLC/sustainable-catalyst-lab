...
def main():
 ...
 if m.get('releaseVersion')!='0.120.0': raise SystemExit('ERROR: releaseVersion mismatch')
 if m.get('exploratoryDataAnalysisStudioVersion')!='0.120.0': raise SystemExit('ERROR: v0.120 feature mismatch')
