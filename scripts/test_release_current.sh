...
node tests/test-v0230.js
php tests/test-v0230.php

node tests/test-v0231.js
php tests/test-v0231.php
...
node tests/test-v0250.js
php tests/test-v0250.php

node tests/test-v0251.js
php tests/test-v0251.php

node tests/test-v0252.js
php tests/test-v0252.php

node tests/test-v0253.js
...
echo "==> v0.100.0 Carbon & Nature MRV Reporting & Audit Packets extension gate"
PYTHON_BIN="${PYTHON_BIN:-python3}" ./scripts/test_v01000_release.sh
