#!/usr/bin/env python3
"""Build the slim Sustainable Catalyst Lab v0.96.0 WordPress runtime package.
...
def main() -> int:
    ...
    required = {
        ...
        "assets/js/modules/carbon-mrv-protocol-v0960.js",
        "assets/css/sc-lab-carbon-mrv-protocol-v0960.css",
        "includes/class-sc-lab-carbon-mrv-protocol-v0960.php",
        "contracts/carbon-mrv-protocol-v1300.schema.json",
        "contracts/carbon-mrv-protocol-validation-v1300.schema.json",
        "contracts/carbon-mrv-protocol-policy-v1300.json",
    }
