...
def main():
 ...
 with zipfile.ZipFile(a.zip_path) as z:
  ...
  if m.get('releaseVersion')!='0.117.0' or m.get('advanced3D4DScientificVisualizationVersion')!='0.117.0': raise SystemExit('ERROR: version mismatch')
  ...
  print('PASS: WordPress ZIP integrity'); print('PASS: releaseVersion=0.117.0'); print('PASS: advanced 3D/4D scientific visualization=0.117.0'); print(f'PASS: verifiedFileCount={len(critical)}')
