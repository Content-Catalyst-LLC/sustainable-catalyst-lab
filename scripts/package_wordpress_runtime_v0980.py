#!/usr/bin/env python3
"""Build the slim Sustainable Catalyst Lab v0.98.0 WordPress runtime package.
...
def main() -> int:
    ...
    required = {
        ...
        "assets/js/modules/carbon-mrv-uncertainty-v0980.js",
        "assets/css/sc-lab-carbon-mrv-uncertainty-v0980.css",
        "includes/class-sc-lab-carbon-mrv-uncertainty-v0980.php",
        "contracts/carbon-mrv-uncertainty-budget-v1500.schema.json",
        "contracts/carbon-mrv-change-detection-v1500.schema.json",
        "contracts/carbon-mrv-detection-sample-size-v1500.schema.json",
        "contracts/carbon-mrv-uncertainty-assessment-v1500.schema.json",
        "contracts/carbon-mrv-uncertainty-assessment-validation-v1500.schema.json",
        "contracts/carbon-mrv-uncertainty-policy-v1500.json",
    }
