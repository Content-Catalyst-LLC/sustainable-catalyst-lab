...
def main():
 ...
 with zipfile.ZipFile(a.zip_path) as z:
  ...
  if m.get('releaseVersion')!='0.118.0' or m.get('visualResearchNarrativeFigureComposerVersion')!='0.118.0': raise SystemExit('ERROR: version mismatch')
  ...
  print('PASS: WordPress ZIP integrity'); print('PASS: releaseVersion=0.118.0'); print('PASS: visual research narrative composer=0.118.0'); print(f'PASS: verifiedFileCount={len(critical)}')
