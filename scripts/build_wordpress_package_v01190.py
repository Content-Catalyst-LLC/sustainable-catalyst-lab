...
def main():
 ...
 if m.get('releaseVersion')!='0.119.0': raise SystemExit('ERROR: releaseVersion mismatch')
 if m.get('scientificFigureIntelligenceAutomaticLayoutVersion')!='0.119.0': raise SystemExit('ERROR: v0.119 feature mismatch')
