...
def main():
 ...
 with zipfile.ZipFile(a.zip_path) as z:
  ...
  if m.get('releaseVersion')!='0.120.0' or m.get('exploratoryDataAnalysisStudioVersion')!='0.120.0': raise SystemExit('ERROR: version mismatch')
  ...
  print('PASS: WordPress ZIP integrity'); print('PASS: releaseVersion=0.120.0'); print('PASS: Exploratory Data Analysis Studio=0.120.0'); print(f'PASS: verifiedFileCount={len(critical)}')
