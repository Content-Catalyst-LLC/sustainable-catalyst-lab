...
def main():
 ...
 if m.get('releaseVersion')!='0.124.0': raise SystemExit('ERROR: releaseVersion mismatch')
 if m.get('sensitivityGlobalUncertaintyAnalysisStudioVersion')!='0.124.0': raise SystemExit('ERROR: v0.124 feature mismatch')
