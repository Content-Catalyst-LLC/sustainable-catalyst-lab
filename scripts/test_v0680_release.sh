...
echo "==> v0.68.0 Hierarchical, Multilevel & Cross-Study Modeling regression gate"
...
php tests/test-v0680.php
php tests/test-v0680-integrity-runtime.php
...
node --check assets/js/modules/evidence-grading-v0650.js
...
php -l includes/class-sc-lab-causal-inference-v0670.php >/dev/null
php -l includes/class-sc-lab-scientific-argumentation-v0660.php >/dev/null
php -l includes/class-sc-lab-evidence-grading-v0650.php >/dev/null
...
"$PYTHON_BIN" -m py_compile backend/app/hierarchical_modeling_v0680.py backend/app/causal_inference_v0670.py backend/app/scientific_argumentation_v0660.py backend/app/scientific_evidence_grading_v0650.py backend/app/systematic_evidence_synthesis_v0640.py backend/app/scientific_literature_provenance_v0630.py backend/app/scientific_claims_traceability_v0620.py backend/app/scientific_study_lifecycle_v0610.py backend/app/beta_field_diagnostics_v0601.py backend/app/integrated_research_beta_v0600.py backend/app/scientific_audit_v0590.py backend/app/scientific_compute_hardening.py backend/app/scientific_workflow_composer.py backend/app/config.py backend/app/main.py
"$PYTHON_BIN" - <<'PY'
from pathlib import Path
text=Path('backend/app/main.py').read_text()
for route in (
 '/v1/hierarchical-modeling/v0680/health','/v1/hierarchical-modeling/v0680/policies','/v1/hierarchical-modeling/v0680/normalize-model','/v1/hierarchical-modeling/v0680/normalize-unit','/v1/hierarchical-modeling/v0680/fit','/v1/hierarchical-modeling/v0680/review','/v1/hierarchical-modeling/v0680/evaluate','/v1/hierarchical-modeling/v0680/packet','/v1/hierarchical-modeling/v0680/verify',
 '/v1/causal-inference/v0670/health','/v1/causal-inference/v0670/policies','/v1/causal-inference/v0670/normalize-design','/v1/causal-inference/v0670/normalize-estimate','/v1/causal-inference/v0670/normalize-diagnostic','/v1/causal-inference/v0670/review','/v1/causal-inference/v0670/evaluate','/v1/causal-inference/v0670/packet','/v1/causal-inference/v0670/verify',
 '/v1/scientific-argumentation/v0660/health','/v1/scientific-argumentation/v0660/policies','/v1/scientific-argumentation/v0660/normalize-case','/v1/scientific-argumentation/v0660/normalize-hypothesis','/v1/scientific-argumentation/v0660/normalize-evidence-link','/v1/scientific-argumentation/v0660/normalize-test','/v1/scientific-argumentation/v0660/review-hypothesis','/v1/scientific-argumentation/v0660/review-case','/v1/scientific-argumentation/v0660/evaluate','/v1/scientific-argumentation/v0660/packet','/v1/scientific-argumentation/v0660/verify',
 '/v1/evidence-grading/v0650/health','/v1/evidence-grading/v0650/policies','/v1/evidence-grading/v0650/normalize-assessment','/v1/evidence-grading/v0650/review','/v1/evidence-grading/v0650/evaluate','/v1/evidence-grading/v0650/packet','/v1/evidence-grading/v0650/verify',
...
print('PASS - v0.68.0 hierarchical modeling + inherited causal/argumentation/evidence routes wired')
PY
"$PYTHON_BIN" - <<'PY'
from pathlib import Path
import hashlib,json
m=json.loads(Path('build/sc-lab-release-manifest.json').read_text())
assert m['releaseVersion']=='0.68.0';assert m['featureVersion']=='0.68.0';assert m['platformVersion']=='1.0.0'
errors=[]
...
PY
echo "PASS - Lab v0.68.0 Hierarchical, Multilevel & Cross-Study Modeling release gate"
