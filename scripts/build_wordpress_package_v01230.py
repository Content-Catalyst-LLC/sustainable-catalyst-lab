...
def main():
 ...
 if m.get('releaseVersion')!='0.123.0': raise SystemExit('ERROR: releaseVersion mismatch')
 if m.get('simulationMonteCarloResearchStudioVersion')!='0.123.0': raise SystemExit('ERROR: v0.123 feature mismatch')
