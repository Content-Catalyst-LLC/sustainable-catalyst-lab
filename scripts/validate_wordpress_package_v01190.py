...
def main():
 ...
 with zipfile.ZipFile(a.zip_path) as z:
  ...
  if m.get('releaseVersion')!='0.119.0' or m.get('scientificFigureIntelligenceAutomaticLayoutVersion')!='0.119.0': raise SystemExit('ERROR: version mismatch')
  ...
  print('PASS: WordPress ZIP integrity'); print('PASS: releaseVersion=0.119.0'); print('PASS: scientific figure intelligence=0.119.0'); print(f'PASS: verifiedFileCount={len(critical)}')
