...
echo "==> v0.48.3 Contextual Navigation & Scientific Workspace Rail Reduction regression gate"
...
node tests/test-v0483.js
php tests/test-v0483.php
php tests/test-v0483-integrity-runtime.php
...
assert m['releaseVersion']=='0.48.3';assert m['featureVersion']=='0.48.3';assert m['platformVersion']=='1.0.0'
errors=[]
...
PY
echo "PASS - Lab v0.48.3 Contextual Navigation & Scientific Workspace Rail Reduction release gate"
