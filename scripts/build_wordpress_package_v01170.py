...
def main():
 ...
 if m.get('releaseVersion')!='0.117.0': raise SystemExit('ERROR: releaseVersion mismatch')
 if m.get('advanced3D4DScientificVisualizationVersion')!='0.117.0': raise SystemExit('ERROR: v0.117 feature mismatch')
