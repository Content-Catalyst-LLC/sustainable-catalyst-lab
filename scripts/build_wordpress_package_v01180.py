...
def main():
 ...
 if m.get('releaseVersion')!='0.118.0': raise SystemExit('ERROR: releaseVersion mismatch')
 if m.get('visualResearchNarrativeFigureComposerVersion')!='0.118.0': raise SystemExit('ERROR: v0.118 feature mismatch')
