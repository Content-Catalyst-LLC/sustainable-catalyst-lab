...
echo "==> v0.48.1 Graph Studio front door + scientific workspace presentation regression gate"
...
node tests/test-v0481.js
php tests/test-v0481.php
php tests/test-v0481-integrity-runtime.php
node --check assets/js/modules/presentation-repair-v0481.js
...
assert m['releaseVersion']=='0.48.1'
assert m['featureVersion']=='0.48.1'
...
echo "PASS - Lab v0.48.1 Graph Studio Front Door & Scientific Workspace Presentation Repair release gate"
