...
def main():
 ...
 if m.get('releaseVersion')!='0.135.8.4.1' or m.get('graphStudioProvenanceInteractionRecoveryVersion')!='0.135.8.4.1': raise SystemExit('ERROR: v0.135.8.4.1 version mismatch')
 ...
 with zipfile.ZipFile(out,'w',zipfile.ZIP_DEFLATED,compresslevel=9) as z:
  zi=zipfile.ZipInfo(f'{ROOT_NAME}/{MANIFEST_REL.as_posix()}',(1980,1,1,0,0,0)); zi.external_attr=(0o100644<<16); zi.compress_type=zipfile.ZIP_DEFLATED; z.writestr(zi,(repo/MANIFEST_REL).read_bytes())
  for rel in sorted(critical):
   zi=zipfile.ZipInfo(f'{ROOT_NAME}/{rel}',(1980,1,1,0,0,0)); zi.external_attr=(0o100644<<16); zi.compress_type=zipfile.ZIP_DEFLATED; z.writestr(zi,(repo/rel).read_bytes())
