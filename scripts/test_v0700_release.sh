...
node tests/test-v0650.js
node tests/test-v0660.js
node tests/test-v0670.js
node tests/test-v0680.js
node tests/test-v0690.js
node tests/test-v0700.js
php tests/test-v0700.php
php tests/test-v0700-integrity-runtime.php
node --check assets/js/modules/preregistration-v0700.js
node --check assets/js/modules/scientific-theory-v0690.js
node --check assets/js/modules/hierarchical-modeling-v0680.js
node --check assets/js/modules/causal-inference-v0670.js
node --check assets/js/modules/scientific-argumentation-v0660.js
...
php -l includes/class-sc-lab-preregistration-v0700.php >/dev/null
php -l includes/class-sc-lab-scientific-theory-v0690.php >/dev/null
php -l includes/class-sc-lab-hierarchical-modeling-v0680.php >/dev/null
php -l templates/lab-app.php >/dev/null
"$PYTHON_BIN" -m py_compile backend/app/preregistration_v0700.py backend/app/scientific_theory_v0690.py backend/app/hierarchical_modeling_v0680.py backend/app/causal_inference_v0670.py backend/app/scientific_argumentation_v0660.py backend/app/scientific_evidence_grading_v0650.py backend/app/systematic_evidence_synthesis_v0640.py backend/app/scientific_literature_provenance_v0630.py backend/app/scientific_claims_traceability_v0620.py backend/app/scientific_study_lifecycle_v0610.py backend/app/beta_field_diagnostics_v0601.py backend/app/integrated_research_beta_v0600.py backend/app/scientific_audit_v0590.py backend/app/scientific_compute_hardening.py backend/app/scientific_workflow_composer.py backend/app/config.py backend/app/main.py
"$PYTHON_BIN" - <<'PY'
from pathlib import Path
text=Path('backend/app/main.py').read_text()
for route in (
 '/v1/preregistration/v0700/health','/v1/preregistration/v0700/policies','/v1/preregistration/v0700/normalize-question','/v1/preregistration/v0700/normalize-hypothesis','/v1/preregistration/v0700/normalize-preregistration','/v1/preregistration/v0700/normalize-deviation','/v1/preregistration/v0700/freeze','/v1/preregistration/v0700/verify-freeze','/v1/preregistration/v0700/review','/v1/preregistration/v0700/evaluate','/v1/preregistration/v0700/packet','/v1/preregistration/v0700/verify',
 '/v1/scientific-theory/v0690/health','/v1/scientific-theory/v0690/policies','/v1/scientific-theory/v0690/normalize-theory','/v1/scientific-theory/v0690/normalize-construct','/v1/scientific-theory/v0690/normalize-relation','/v1/scientific-theory/v0690/normalize-prediction','/v1/scientific-theory/v0690/graph','/v1/scientific-theory/v0690/review','/v1/scientific-theory/v0690/evaluate','/v1/scientific-theory/v0690/packet','/v1/scientific-theory/v0690/verify',
 '/v1/hierarchical-modeling/v0680/health','/v1/causal-inference/v0670/health','/v1/scientific-argumentation/v0660/health','/v1/evidence-grading/v0650/health','/v1/evidence-synthesis/v0640/health','/v1/scientific-literature/v0630/health','/v1/scientific-claims/v0620/health','/v1/scientific-studies/v0610/health','/v1/beta-diagnostics/v0601/health'):
    assert route in text, f'missing FastAPI route: {route}'
print('PASS - v0.70.0 preregistration + inherited theory/modeling/evidence routes wired')
PY
"$PYTHON_BIN" - <<'PY'
from pathlib import Path
import hashlib,json
m=json.loads(Path('build/sc-lab-release-manifest.json').read_text())
assert m['releaseVersion']=='0.70.0';assert m['featureVersion']=='0.70.0';assert m['platformVersion']=='1.0.0';assert m['moduleCount']==147;assert m['routeAssertions']==393
errors=[]
...
PY
echo "PASS - Lab v0.70.0 Research Questions, Hypothesis Registry & Preregistration release gate"
