...
echo "Testing Sustainable Catalyst Lab v0.5.0"
...
grep -q 'Version: 0.5.0' "$ROOT/sustainable-catalyst-lab.php"
grep -q "define('SC_LAB_VERSION', '0.5.0')" "$ROOT/sustainable-catalyst-lab.php"
