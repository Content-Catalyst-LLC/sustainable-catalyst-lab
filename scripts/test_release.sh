...
echo "Testing Sustainable Catalyst Lab v0.1.1"
...
grep -q 'Version: 0.1.1' "$ROOT/sustainable-catalyst-lab.php"
grep -q "define('SC_LAB_VERSION', '0.1.1')" "$ROOT/sustainable-catalyst-lab.php"
