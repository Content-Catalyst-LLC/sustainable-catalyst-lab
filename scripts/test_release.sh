...
echo "Testing Sustainable Catalyst Lab v0.6.0"
...
grep -q 'Version: 0.6.0' "$ROOT/sustainable-catalyst-lab.php"
grep -q "define('SC_LAB_VERSION', '0.6.0')" "$ROOT/sustainable-catalyst-lab.php"
