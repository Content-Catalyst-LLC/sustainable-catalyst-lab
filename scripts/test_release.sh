...
echo "Testing Sustainable Catalyst Lab v0.9.3"
...
grep -q 'Version: 0.9.3' "$ROOT/sustainable-catalyst-lab.php"
grep -q "define('SC_LAB_VERSION', '0.9.3')" "$ROOT/sustainable-catalyst-lab.php"
