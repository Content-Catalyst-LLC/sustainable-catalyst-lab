...
echo "Testing Sustainable Catalyst Lab v0.9.5"
...
grep -q 'Version: 0.9.5' "$ROOT/sustainable-catalyst-lab.php"
grep -q "define('SC_LAB_VERSION', '0.9.5')" "$ROOT/sustainable-catalyst-lab.php"
grep -q 'type: worker' "$ROOT/render.yaml"
grep -q 'type: keyvalue' "$ROOT/render.yaml"
echo "Release tests passed."

# Lab v0.9.5 report-composer, accessibility, migration, and restore checks.
