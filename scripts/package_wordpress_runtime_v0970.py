#!/usr/bin/env python3
"""Build the slim Sustainable Catalyst Lab v0.97.0 WordPress runtime package.
...
def main() -> int:
    ...
    required = {
        ...
        "assets/js/modules/carbon-mrv-monitoring-v0970.js",
        "assets/css/sc-lab-carbon-mrv-monitoring-v0970.css",
        "includes/class-sc-lab-carbon-mrv-monitoring-v0970.php",
        "contracts/carbon-mrv-monitoring-plan-v1400.schema.json",
        "contracts/carbon-mrv-monitoring-plan-validation-v1400.schema.json",
        "contracts/carbon-mrv-sample-size-v1400.schema.json",
        "contracts/carbon-mrv-stratified-allocation-v1400.schema.json",
        "contracts/carbon-mrv-monitoring-plan-policy-v1400.json",
    }
