...
def main():
 ...
 with zipfile.ZipFile(a.zip_path) as z:
  ...
  if m.get('releaseVersion')!='0.124.0' or m.get('sensitivityGlobalUncertaintyAnalysisStudioVersion')!='0.124.0': raise SystemExit('ERROR: version mismatch')
  ...
  print('PASS: WordPress ZIP integrity'); print('PASS: releaseVersion=0.124.0'); print('PASS: Sensitivity & Global Uncertainty Analysis Studio=0.124.0'); print(f'PASS: verifiedFileCount={len(critical)}')
