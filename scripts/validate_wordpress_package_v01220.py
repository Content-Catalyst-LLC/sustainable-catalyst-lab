...
def main():
 ...
 with zipfile.ZipFile(a.zip_path) as z:
  ...
  if m.get('releaseVersion')!='0.122.0' or m.get('bayesianAnalysisWorkbenchVersion')!='0.122.0': raise SystemExit('ERROR: version mismatch')
  ...
  print('PASS: WordPress ZIP integrity'); print('PASS: releaseVersion=0.122.0'); print('PASS: Bayesian Analysis Workbench II=0.122.0'); print(f'PASS: verifiedFileCount={len(critical)}')
