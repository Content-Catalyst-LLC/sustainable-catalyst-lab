...
def main():
 ...
 if m.get('releaseVersion')!='0.121.0': raise SystemExit('ERROR: releaseVersion mismatch')
 if m.get('statisticalModelingDiagnosticsStudioVersion')!='0.121.0': raise SystemExit('ERROR: v0.120 feature mismatch')
