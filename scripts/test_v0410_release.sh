...
php -l includes/class-sc-lab-model-studio-v0410.php >/dev/null
php -l includes/class-sc-lab-python-compute-core-v0261.php >/dev/null
php -l templates/lab-app.php >/dev/null
"$PYTHON_BIN" -m py_compile backend/app/model_studio.py backend/app/main.py
...
echo "PASS - Lab Model Studio v0.41.0 feature-layer release gate"
