...
def main():
 ...
 with zipfile.ZipFile(a.zip_path) as z:
  ...
  if m.get('releaseVersion')!='0.116.0': raise SystemExit('ERROR: releaseVersion is not 0.116.0')
  ...
  print('PASS: WordPress ZIP integrity'); print('PASS: releaseVersion=0.116.0'); print('PASS: interactive scientific dashboards=0.116.0'); print(f'PASS: verifiedFileCount={len(critical)}')
