...
def main():
 ...
 if m.get('releaseVersion')!='0.122.0': raise SystemExit('ERROR: releaseVersion mismatch')
 if m.get('bayesianAnalysisWorkbenchVersion')!='0.122.0': raise SystemExit('ERROR: v0.122 feature mismatch')
