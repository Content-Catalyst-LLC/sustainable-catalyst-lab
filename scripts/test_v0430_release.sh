...
echo "==> Model Diagnostics + scientific modeling regression gate"
...
node tests/test-v0430.js
php tests/test-v0430.php
php tests/test-v0430-integrity-runtime.php
node --check assets/js/modules/scientific-visualization-engine-v0410.js
node --check assets/js/modules/model-studio-v0430.js
node --check assets/js/modules/numerical-visualization-studio.js
php -l sustainable-catalyst-lab.php >/dev/null
php -l includes/class-sc-lab-plugin.php >/dev/null
php -l includes/class-sc-lab-model-studio-v0430.php >/dev/null
...
assert m['releaseVersion']=='0.43.0'
assert m['featureVersion']=='0.43.0'
...
echo "PASS - Lab v0.43.0 Model Diagnostics, Cross-Validation & Scientific Model Comparison release gate"
