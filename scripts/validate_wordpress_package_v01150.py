...
def main():
 ...
 with zipfile.ZipFile(a.zip_path) as z:
  ...
  if m.get('releaseVersion')!='0.115.0': raise SystemExit('ERROR: releaseVersion is not 0.115.0')
  if m.get('advancedStatisticalUncertaintyGraphicsVersion')!='0.115.0': raise SystemExit('ERROR: statistical-graphics version mismatch')
  ...
  print('PASS: WordPress ZIP integrity'); print('PASS: releaseVersion=0.115.0'); print('PASS: advanced statistical & uncertainty graphics=0.115.0'); print(f'PASS: verifiedFileCount={len(critical)}')
