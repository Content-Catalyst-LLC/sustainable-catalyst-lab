...
echo "==> v0.72.1 Homepage Biodiversity Time-Sweep Loop regression gate"
node --check assets/js/modules/advanced-visualization-front-door-v0710.js
node --check assets/js/modules/homepage-biodiversity-loop-v0721.js
node tests/test-v0710.js
node tests/test-v0720.js
node tests/test-v0721.js
php tests/test-v0720-render.php
php tests/test-v0721.php
php tests/test-v0721-render.php
...
assert m['releaseVersion']=='0.72.1'
assert m['featureVersion']=='0.72.1'
...
print(f"PASS - v0.72.1 release manifest integrity ({len(m['wordpressCriticalFiles'])} WordPress/source + {len(m['backendCriticalFiles'])} backend files)")
PY

echo "PASS - Lab v0.72.1 Homepage Biodiversity Time-Sweep Loop release gate"
