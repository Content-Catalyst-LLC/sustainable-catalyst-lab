...
final class SC_Lab_Functional_Validation_V0264 {
    ...
    public static function modules() {
        ...
        $overrides = array(
            ...
            'design-studies' => array('controllerPaths'=>array('SCLab.DesignStudiesV0301'),'actionSelector'=>'[data-doe-v0301-generate]','outputSelector'=>'[data-doe-v0301-status]','actionMode'=>'interface','timeoutMs'=>20000,'requirement'=>'backend-optional'),
            'model-calibration' => array('controllerPaths'=>array('SCLab.ModelCalibrationV0302'),'actionSelector'=>'[data-cal-v0302-run]','outputSelector'=>'[data-cal-v0302-status]','actionMode'=>'interface','timeoutMs'=>30000,'requirement'=>'backend-optional'),
            'distributed-dispatcher' => array('controllerPaths'=>array('SCLab.DistributedDispatcherV0310'),'actionSelector'=>'[data-dsp-v0310-register]','outputSelector'=>'[data-dsp-v0310-status]','actionMode'=>'interface','timeoutMs'=>20000,'requirement'=>'backend-optional'),
            'persistent-queue' => array('controllerPaths'=>array('SCLab.PersistentQueueV0311'),'actionSelector'=>'[data-pq-v0311-refresh]','outputSelector'=>'[data-pq-v0311-status]','actionMode'=>'refresh','timeoutMs'=>20000,'requirement'=>'backend-required'),
            'worker-agent' => array('controllerPaths'=>array('SCLab.WorkerAgentV0312'),'actionSelector'=>'[data-wa-v0312-refresh]','outputSelector'=>'[data-wa-v0312-status]','actionMode'=>'refresh','timeoutMs'=>20000,'requirement'=>'backend-required'),
    ...
    public static function server_health() {
        ...
        $ok = !in_array(false, array_map(function($row){ return !empty($row['exists']); }, $files), true) && $module_count === 56;
    ...
    public static function admin_page() {
        ...
        <div class="wrap sc-lab-functional-admin-v0264" data-sc-lab-functional-admin-v0264>
          ...
          <div class="sc-lab-functional-toolbar-v0264">
            ...
            <button type="button" class="button" data-functional-run-all>Run all 54 panels</button>
          ...
          <div class="sc-lab-functional-progress-v0264" aria-live="polite"><progress max="54" value="0" data-functional-progress></progress><span data-functional-progress-label>0 / 0</span></div>
