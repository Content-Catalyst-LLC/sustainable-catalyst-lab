...
final class SC_Lab_Functional_Validation_V0264 {
    ...
    public static function server_health() {
        ...
        $ok = !in_array(false, array_map(function($row){ return !empty($row['exists']); }, $files), true) && $module_count === 47;
    ...
    public static function admin_page() {
        ...
        <div class="wrap sc-lab-functional-admin-v0264" data-sc-lab-functional-admin-v0264>
          ...
          <div class="sc-lab-functional-toolbar-v0264">
            ...
            <button type="button" class="button" data-functional-run-all>Run all 47 panels</button>
          ...
          <div class="sc-lab-functional-progress-v0264" aria-live="polite"><progress max="47" value="0" data-functional-progress></progress><span data-functional-progress-label>0 / 0</span></div>
