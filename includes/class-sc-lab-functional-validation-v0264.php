...
final class SC_Lab_Functional_Validation_V0264 {
    ...
    public static function modules() {
        $labels = array(
            'activity'=>'Activity','aerospace-engineering-flight-systems'=>'Aerospace Engineering and Flight Systems','architecture-building'=>'Architecture and Building Performance','astronomy'=>'Astronomy Calculations','biochemistry-molecular-analysis'=>'Biochemistry and Molecular Analysis','biology'=>'Biology','biomedical-engineering-biosignals'=>'Biomedical Engineering and Biosignals','biotechnology-bioprocess-engineering'=>'Biotechnology and Bioprocess Engineering','chemistry'=>'Chemistry','circular-economy-industrial-ecology'=>'Circular Economy and Industrial Ecology','civil-infrastructure'=>'Civil Engineering and Infrastructure','climate-maps'=>'Climate Maps','code-studio'=>'Code Studio','comparative-economics-development-systems'=>'Comparative Economics and Development Systems','dataset-inspector'=>'Dataset Inspector','documentation'=>'Documentation','earth-systems'=>'Earth Systems','electrical-embedded'=>'Electrical, Electronics, and Embedded Systems','energy-engineering'=>'Energy and Engineering','evidence-decisions'=>'Evidence and Decisions','experiments'=>'Experiments','genetics-genomics-sequence-analysis'=>'Genetics and Genomics','laboratory-data-instrumentation'=>'Laboratory Data and Instrumentation','marine-biology'=>'Marine Biology','materials'=>'Materials','mechanical-thermal'=>'Mechanical and Thermal Engineering','microbiology-laboratory'=>'Microbiology','notebook'=>'Notebook','numerical-methods'=>'Numerical Methods Studio','numerical-validation'=>'Numerical Validation Library','numerical-governance'=>'Precision and Solver Governance','long-running-jobs'=>'Long Jobs and Checkpoints','overview'=>'Overview','physics'=>'Physics','report-studio'=>'Report Studio','rocket-propulsion-spaceflight'=>'Rocket Propulsion and Spaceflight','science-engineering'=>'Science and Engineering','scientific-feeds'=>'Scientific Feeds','source-registry'=>'Source Registry','space-telescopes'=>'Space and Astronomy Observations','sustainable-cities-resilience'=>'Sustainable Cities and Urban Resilience','system-status'=>'System Status','urban-planning-spatial'=>'Urban Planning and Spatial Systems','visualization-studio'=>'Visualization Studio','workspace-data'=>'Workspace Data'
        );
        $priority = array('climate-maps','marine-biology','space-telescopes','numerical-methods','numerical-validation','numerical-governance','long-running-jobs','astronomy','microbiology-laboratory','chemistry','physics','biology','earth-systems','energy-engineering','materials','electrical-embedded','mechanical-thermal','civil-infrastructure');
        $specs = array();
        foreach ($labels as $module => $label) {
            $specs[$module] = array(
                'module' => $module,
                'label' => $label,
                'group' => in_array($module, array('scientific-feeds','climate-maps','space-telescopes','marine-biology','source-registry','dataset-inspector'), true) ? 'Observe' : 'Laboratory',
    ...
    public static function server_health() {
        ...
        $ok = !in_array(false, array_map(function($row){ return !empty($row['exists']); }, $files), true) && $module_count === 43;
    ...
    public static function admin_page() {
        ...
        <div class="wrap sc-lab-functional-admin-v0264" data-sc-lab-functional-admin-v0264>
          ...
          <div class="sc-lab-functional-toolbar-v0264">
            ...
            <button type="button" class="button" data-functional-run-all>Run all 43 panels</button>
          ...
          <div class="sc-lab-functional-progress-v0264" aria-live="polite"><progress max="43" value="0" data-functional-progress></progress><span data-functional-progress-label>0 / 0</span></div>
