...
final class SC_Lab_Plugin {
  ...
  wp_enqueue_style('sc-lab-v095', SC_LAB_URL . 'assets/css/sc-lab-v095.css', array('sc-lab-app'), $this->asset_version('assets/css/sc-lab-v095.css'));
        ...
        wp_enqueue_style('sc-lab-graph-studio-v0470', SC_LAB_URL . 'assets/css/sc-lab-graph-studio-v0470.css', array('sc-lab-scientific-visualization-engine-v0740'), $this->asset_version('assets/css/sc-lab-graph-studio-v0470.css'));
        ...
        wp_localize_script('sc-lab-app', 'SCLabConfig', array(
            ...
            'visualizationEngine2' => array('version'=>'0.74.0','engineVersion'=>'2.1.0','schemaUrl'=>esc_url_raw(rest_url('sc-lab/v1/visualization/v0740/schema')),'healthUrl'=>esc_url_raw(rest_url('sc-lab/v1/visualization/v0740/health')),'renderers'=>array('svg2d','canvas4d'),'advanced2d'=>true,'surface4d'=>true,'surface4dProjectDataBinding'=>false),
            'longJobs' => array(
                'version' => '0.27.2',
