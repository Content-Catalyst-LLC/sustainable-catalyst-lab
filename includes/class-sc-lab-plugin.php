...
final class SC_Lab_Plugin {
  ...
  wp_enqueue_style('sc-lab-v095', SC_LAB_URL . 'assets/css/sc-lab-v095.css', array('sc-lab-app'), $this->asset_version('assets/css/sc-lab-v095.css'));
        ...
        wp_enqueue_style('sc-lab-model-studio-v0430', SC_LAB_URL . 'assets/css/sc-lab-model-studio-v0430.css', array('sc-lab-scientific-visualization-engine-v0410'), $this->asset_version('assets/css/sc-lab-model-studio-v0430.css'));
