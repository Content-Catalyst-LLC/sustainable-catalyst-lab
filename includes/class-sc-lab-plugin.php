...
final class SC_Lab_Plugin {
  ...
  wp_enqueue_style('sc-lab-v095', SC_LAB_URL . 'assets/css/sc-lab-v095.css', array('sc-lab-app'), $this->asset_version('assets/css/sc-lab-v095.css'));
        ...
        wp_enqueue_style('sc-lab-graph-studio-v0470', SC_LAB_URL . 'assets/css/sc-lab-graph-studio-v0470.css', array('sc-lab-scientific-visualization-engine-v0730'), $this->asset_version('assets/css/sc-lab-graph-studio-v0470.css'));
        ...
        wp_localize_script('sc-lab-app', 'SCLabConfig', array(
            ...
            'visualizationEngine2' => array('version'=>'0.73.0','engineVersion'=>'2.0.0','schemaUrl'=>esc_url_raw(rest_url('sc-lab/v1/visualization/v0730/schema')),'healthUrl'=>esc_url_raw(rest_url('sc-lab/v1/visualization/v0730/health')),'renderers'=>array('svg2d','canvas4d'),'surface4d'=>true,'surface4dProjectDataBinding'=>false),
            'longJobs' => array(
                'version' => '0.27.2',
