...
final class SC_Lab_Plugin {
  ...
  wp_enqueue_style('sc-lab-v095', SC_LAB_URL . 'assets/css/sc-lab-v095.css', array('sc-lab-app'), $this->asset_version('assets/css/sc-lab-v095.css'));
        ...
        $modules = array('core','projects','project-workspace-v0280','feeds','climate-map','periodic-table','stoichiometry','chemistry-lab','spectrometry','calculators','datasets','dataset-registry-v0281','reproducible-runs-v0282','research-provenance-v0290','research-quality-v0291','external-discovery-v0292','experiment-framework-v0300','design-studies-v0301','model-calibration-v0302','workflow-orchestration-v0321','workflow-automation-v0322','experiment-campaigns-v0331','closed-loop-campaigns-v0332','model-registry-v0340','ensemble-uncertainty-v0341','surrogate-reduced-order-v0342','team-workspaces-v0350','workspace-review-v0351','workspace-versioning-v0352','artifact-repository-v0360','institutional-node-federation-v0361','distributed-dispatcher-v0310','persistent-queue-v0311','dispatcher-operations-v0314','worker-agent-v0312','artifact-transport-v0313','observations','physics-lab','physics-validation','biology-lab','astronomy-lab','materials-lab','earth-lab','energy-lab','electrical-embedded-lab','mechanical-thermal-lab','civil-infrastructure-lab','method-contracts','compute-client','numerical-methods-studio','numerical-validation-studio','numerical-governance-studio','numerical-visualization-studio','long-running-jobs-studio','code-switcher','visualization','reporting','dimensional-visualization','data-management','workspace','release-v095');
