...
final class SC_Lab_Plugin {
  ...
  wp_enqueue_style('sc-lab-v095', SC_LAB_URL . 'assets/css/sc-lab-v095.css', array('sc-lab-app'), $this->asset_version('assets/css/sc-lab-v095.css'));
        ...
        wp_enqueue_style('sc-lab-graph-studio-v0470', SC_LAB_URL . 'assets/css/sc-lab-graph-studio-v0470.css', array('sc-lab-scientific-scene-v0770'), $this->asset_version('assets/css/sc-lab-graph-studio-v0470.css'));
        ...
        wp_localize_script('sc-lab-app', 'SCLabConfig', array(
            ...
            'visualizationEngine2' => array('version'=>'0.77.0','engineVersion'=>'2.4.0','schemaUrl'=>esc_url_raw(rest_url('sc-lab/v1/visualization/v0770/schema')),'healthUrl'=>esc_url_raw(rest_url('sc-lab/v1/visualization/v0770/health')),'renderers'=>array('svg2d','canvas3d','canvas4d'),'advanced2d'=>true,'datasetBinding'=>true,'transformationPipeline'=>true,'largeDataVisualization'=>true,'adaptiveRendering'=>true,'progressiveRendering'=>true,'scientificScene3d'=>true,'pointCloud3d'=>true,'mesh3d'=>true,'vectorField3d'=>true,'cameraProjections'=>array('perspective','orthographic'),'webgl'=>false,'sourceRowLimit'=>250000,'renderPointLimit'=>5000,'surface4d'=>true,'surface4dProjectDataBinding'=>true,'surfaceInterpolation'=>false),
            'longJobs' => array(
                'version' => '0.27.2',
