...
final class SC_Lab_Integrity_V02632 {
    ...
    private static function release_state() {
        ...
        $visualization_engine = class_exists('SC_Lab_Provenance_Aware_Figures_V0830') ? SC_Lab_Provenance_Aware_Figures_V0830::ENGINE_VERSION : (class_exists('SC_Lab_Uncertainty_Ensemble_Distribution_V0820') ? SC_Lab_Uncertainty_Ensemble_Distribution_V0820::ENGINE_VERSION : null);
        $versions = array(
