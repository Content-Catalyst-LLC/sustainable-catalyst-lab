...
VERSION="0.135.8.5.3"
ROUTE_COUNT=6
def health(): return {"ok":True,"version":VERSION,"api_route_count":ROUTE_COUNT,"provenance_owner":"0.135.8.5.3","legacy_interaction_enabled":False,"legacy_observer_attached":False,"browser_certification_required":True}
