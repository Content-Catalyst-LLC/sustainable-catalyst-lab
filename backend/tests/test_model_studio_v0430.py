...
def test_model_studio_advances_to_v0430_contracts():
    ...
    assert model["schema"] == "sc-lab-model-studio-model/0.43.0"
    assert model["version"] == "0.43.0"
...
def test_shared_graph_contract_preserves_comparison_bars():
    ...
    assert graph["schema"] == "sc-lab-scientific-graph/0.43.0"
...
def test_bundle_adds_model_diagnostics_handoff():
    ...
    assert bundle["schema"] == "sc-lab-model-studio-bundle/0.43.0"
