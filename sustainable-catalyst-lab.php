...
define('SC_LAB_RELEASE_VERSION', '0.43.0');
...
// v0.43.0 Model Diagnostics, Cross-Validation & Scientific Model Comparison; v0.42 equation grammar and v0.41 visualization remain shared foundations.
require_once plugin_dir_path(__FILE__) . 'includes/class-sc-lab-model-studio-v0430.php';
SC_Lab_Model_Studio_V0430::init();
