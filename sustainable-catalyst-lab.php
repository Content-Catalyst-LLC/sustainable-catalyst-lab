...
require_once plugin_dir_path(__FILE__) . 'includes/class-sc-lab-civil-interface-authority-v0200.php';
require_once plugin_dir_path(__FILE__) . 'includes/class-sc-lab-civil-direct-loader-v0200.php';
