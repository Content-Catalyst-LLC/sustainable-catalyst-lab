...
define('SC_LAB_RELEASE_VERSION', '0.45.0');
...
// v0.45.0 Dynamic Systems, ODE Models & Parameter Estimation; v0.44 graph engine, v0.43 diagnostics, and v0.42 equation grammar remain governed foundations.
require_once plugin_dir_path(__FILE__) . 'includes/class-sc-lab-model-studio-v0450.php';
SC_Lab_Model_Studio_V0450::init();
