...
define('SC_LAB_RELEASE_VERSION', '0.42.0');
...
// v0.42.0 Scientific Equation Builder & Model Definition; v0.41.0 visualization foundation remains shared infrastructure.
require_once plugin_dir_path(__FILE__) . 'includes/class-sc-lab-model-studio-v0420.php';
SC_Lab_Model_Studio_V0420::init();
