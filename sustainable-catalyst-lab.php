...
// v0.41.0 Model Studio and Scientific Visualization Foundation feature layer.
require_once plugin_dir_path(__FILE__) . 'includes/class-sc-lab-model-studio-v0410.php';
SC_Lab_Model_Studio_V0410::init();
