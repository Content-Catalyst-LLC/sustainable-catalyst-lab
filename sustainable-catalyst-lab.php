...
define('SC_LAB_RELEASE_VERSION', '0.44.0');
...
// v0.44.0 Interactive Scientific Graph Engine & Publication Graphics; v0.43 diagnostics and v0.42 equation grammar remain governed foundations.
require_once plugin_dir_path(__FILE__) . 'includes/class-sc-lab-model-studio-v0440.php';
SC_Lab_Model_Studio_V0440::init();
