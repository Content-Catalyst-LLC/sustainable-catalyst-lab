  ...
  <div data-laboratory-instrumentation-root></div>
    ...
    <div data-instrumentation-validation-custody-root></div>
      ...
      <section class="sc-lab-panel sc-lab-module sc-gs0470" data-lab-module="graph-studio" data-module-panel="graph-studio" hidden>
        <header class="sc-lab-module-header"><p class="sc-lab-kicker">VISUALIZE / GRAPH STUDIO / v0.78.0</p><h3>Scientific Visualization Workspace</h3><p>Build governed 2D, 3D, and 4D scientific figures from real datasets. v0.78 adds observed 4D state spaces, discrete time-state playback, parameter sweeps, hyperslicing, and XW/YW/ZW projection controls while preserving the v0.77 native 3D scene engine, v0.76 adaptive rendering, and v0.75 transformation lineage.</p></header>
