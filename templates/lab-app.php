  ...
  <div data-laboratory-instrumentation-root></div>
    ...
    <div data-instrumentation-validation-custody-root></div>
      ...
      <section class="sc-lab-panel sc-lab-module sc-gs0470" data-lab-module="graph-studio" data-module-panel="graph-studio" hidden>
        <header class="sc-lab-module-header"><p class="sc-lab-kicker">VISUALIZE / GRAPH STUDIO / v0.75.0</p><h3>Scientific Visualization Workspace</h3><p>Bind real scientific datasets to governed visual encodings, apply reproducible transformations with lineage, inspect the resulting figure, and save dataset/pipeline/binding provenance with every Graph Studio figure. v0.75 builds on the v0.74 Cartesian plot grammar and adds project-data 4D point projection without fabricating an interpolated surface.</p></header>
          ...
          <aside class="sc-gs0470-controls" aria-label="Figure controls">
            <section class="sc-gs0470-card"><h4>Figure definition</h4>
              <label>Visualization type<select data-gs-v0470-kind>
                ...
                <optgroup label="Higher-dimensional"><option value="surface-4d">4D response surface · Canvas</option></optgroup>
              </select></label>
              ...
              <div class="sc-gs0470-actions"><button type="button" class="sc-lab-button" data-gs-v0470-example>Load bound 2D example</button><button type="button" class="sc-lab-button" data-gs-v0730-example-4d>Load bound 4D example</button><button type="button" class="sc-lab-button sc-lab-button-primary" data-gs-v0470-render>Transform + bind + render</button></div>
            </section>
            ...
            <section class="sc-gs0470-card"><h4>Figure actions</h4><p class="sc-lab-data-note">Every saved v0.75 figure carries dataset, pipeline, binding, and output fingerprints alongside the renderer-aware figure specification. SVG/PNG/CSV/JSON remain available for 2D; project-data 4D uses PNG/JSON.</p>
