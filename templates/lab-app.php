  ...
  <div data-laboratory-instrumentation-root></div>
    ...
    <div data-instrumentation-validation-custody-root></div>
      ...
      <section class="sc-lab-panel sc-lab-module sc-gs0470" data-lab-module="graph-studio" data-module-panel="graph-studio" hidden>
        <header class="sc-lab-module-header"><p class="sc-lab-kicker">VISUALIZE / GRAPH STUDIO / v0.74.0</p><h3>Scientific Visualization Workspace</h3><p>Build, inspect, refine, save, and reuse governed scientific figures through one renderer-aware Graph Studio contract. v0.74 expands the SVG path into a publication-grade Cartesian plot grammar while preserving legacy figures and the first-class 4D canvas.</p></header>
        ...
        <div class="sc-gs0470-shell">
          <aside class="sc-gs0470-controls" aria-label="Figure controls">
            <section class="sc-gs0470-card"><h4>Figure definition</h4>
              ...
              <p class="sc-gs0740-boundary" data-gs-v0730-tabular-only>v0.74 is intentionally Cartesian: polar/radar and dual-axis figures are deferred rather than represented misleadingly. General dataset binding and transformation provenance follow in v0.75.</p>
            ...
            <section class="sc-gs0470-card"><h4>Figure actions</h4><p class="sc-lab-data-note">Renderer-aware exports remain available directly in the figure canvas: SVG/PNG/CSV/JSON for the expanded 2D grammar and PNG/JSON snapshots for the first-class 4D canvas.</p>
