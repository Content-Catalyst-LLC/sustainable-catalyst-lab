      ...
      <section class="sc-lab-panel sc-lab-module sc-ms0460" data-lab-module="model-studio" data-module-panel="model-studio" hidden>
        ...
        <div class="sc-ms0460-grid">
          ...
          <section class="sc-ms0460-card"><h4>Data binding &amp; scientific graph</h4>
            ...
            <h4>Governed handoffs</h4><div class="sc-ms0460-handoffs"><button type="button" class="sc-lab-button" data-ms-v0460-handoff="response-surfaces">Response surfaces</button><button type="button" class="sc-lab-button" data-ms-v0460-handoff="dynamic-systems">Dynamic systems</button><button type="button" class="sc-lab-button" data-ms-v0460-handoff="model-diagnostics">Diagnostics evidence</button><button type="button" class="sc-lab-button" data-ms-v0460-handoff="model-calibration">Calibration</button><button type="button" class="sc-lab-button" data-ms-v0460-handoff="design-studies">Design studies</button><button type="button" class="sc-lab-button" data-ms-v0460-open-probabilistic>Uncertainty &amp; sensitivity</button><button type="button" class="sc-lab-button" data-ms-v0460-handoff="ensemble-uncertainty">Registered-model ensemble</button><button type="button" class="sc-lab-button" data-ms-v0460-handoff="model-registry">Model registry</button><button type="button" class="sc-lab-button" data-ms-v0460-handoff="workbench">Workbench</button></div>
...
P=1:9:bar</textarea></label>
  ...
  "sourceRevision": "replace-with-git-commit"
      ...
      <section class="sc-lab-panel sc-lab-module sc-pa0480" data-lab-module="probabilistic-analysis" data-module-panel="probabilistic-analysis" hidden>
        <header class="sc-lab-module-header"><p class="sc-lab-kicker">MODEL / UNCERTAINTY &amp; SENSITIVITY / v0.48.0</p><h3>Integrated Uncertainty, Sensitivity &amp; Probabilistic Visualization</h3><p>Propagate explicit input and parameter uncertainty through safe declarative Model Studio models, quantify output distributions and threshold probabilities, rank global sensitivity, and carry probabilistic figures directly into Graph Studio.</p></header>
