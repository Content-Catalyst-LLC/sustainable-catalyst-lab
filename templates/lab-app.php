  ...
  <div data-laboratory-instrumentation-root></div>
    ...
    <div data-instrumentation-validation-custody-root></div>
      ...
      <section class="sc-lab-panel sc-lab-module sc-gs0470" data-lab-module="graph-studio" data-module-panel="graph-studio" hidden>
        <header class="sc-lab-module-header"><p class="sc-lab-kicker">VISUALIZE / GRAPH STUDIO / v0.77.0</p><h3>Scientific Visualization Workspace</h3><p>Build governed 2D, 3D, and 4D scientific figures from real datasets. v0.77 adds a native three-dimensional scene engine with explicit x/y/z coordinates, perspective or orthographic cameras, depth-sorted point clouds, trajectories, vector fields, and explicit triangle meshes while preserving the v0.75 data-binding and v0.76 adaptive-rendering lineage.</p></header>
        ...
        <div class="sc-gs0470-shell">
          <aside class="sc-gs0470-controls" aria-label="Figure controls">
            <section class="sc-gs0470-card"><h4>Figure definition</h4>
              ...
              <div class="sc-gs0470-actions"><button type="button" class="sc-lab-button" data-gs-v0470-example>Load bound 2D example</button><button type="button" class="sc-lab-button" data-gs-v0770-example-3d>Load 3D mesh example</button><button type="button" class="sc-lab-button" data-gs-v0730-example-4d>Load bound 4D example</button><button type="button" class="sc-lab-button sc-lab-button-primary" data-gs-v0470-render>Transform + bind + render</button></div>
            </section>
            ...
            <section class="sc-gs0470-card"><h4>Figure actions</h4><p class="sc-lab-data-note">Every saved v0.77 figure preserves its renderer-aware specification and provenance. Dataset-bound figures retain transformation/adaptive lineage; 3D scenes additionally retain camera, explicit geometry, scene bounds, and scene provenance. SVG/PNG/CSV/JSON remain available for 2D; canvas3d and canvas4d use PNG/JSON.</p>
