...
4,0.405</textarea></label><label>Unknown signal<input type="number" step="any" value="0.256" data-chem-cal-unknown></label><button class="sc-lab-button sc-lab-button-primary" data-chem-cal-run>Fit calibration and estimate unknown</button><pre data-chem-cal-output></pre></article>
      ...
      <section class="sc-lab-panel" data-lab-module="soil-organic-carbon" hidden>
        ...
        <div class="sc-soc0900" data-soc-v0900-root>
          <div class="sc-soc0900__hero">
            <div><span class="sc-lab-section-code">CARBON &amp; NATURE / SOC / v0.9.0</span><h3>SOC Spatial Variability &amp; Uncertainty</h3><p>Quantify replicate variability, Student-t confidence intervals, spatial coverage diagnostics, area-weighted stratified estimates, and paired or independent uncertainty around SOC stock change.</p></div>
            <div class="sc-soc0900__badges"><span class="sc-soc0900__badge">Lab v0.92.0</span><span class="sc-soc0900__badge">Replicate statistics</span><span class="sc-soc0900__badge">95% CI</span><span class="sc-soc0900__badge">Backend: <b data-soc-v0900-backend>checking</b></span></div>
          </div>
          <div class="sc-soc0900__notice"><strong>Uncertainty boundary:</strong> sample variability is not total project uncertainty. Coordinate diagnostics do not establish spatial representativeness; no outliers are removed automatically; no variogram, kriging, causal attribution, verification, or carbon-credit eligibility is inferred.</div>
          <div class="sc-soc0900__grid">
            <div class="sc-soc0900__card"><h4>Replicate stock uncertainty</h4><div class="sc-soc0900__fields"><label>Estimate ID<input data-soc-v0900-estimate-id value="estimate:soc-replicates"></label><label>Spatial unit ID<input data-soc-v0900-spatial-unit placeholder="parcel:..."></label><label>Confidence<select data-soc-v0900-confidence><option value="0.90">90%</option><option value="0.95" selected>95%</option><option value="0.99">99%</option></select></label></div><label>Replicate SOC stocks (Mg C/ha)<textarea data-soc-v0900-stocks placeholder="76, 78, 80, 82"></textarea></label><div class="sc-soc0900__actions"><button type="button" class="sc-lab-button" data-soc-v0900-example>Load example</button><button type="button" class="sc-lab-button sc-lab-button-primary" data-soc-v0900-summarize>Summarize variability</button></div>
...
Upper assumption: 3"></textarea></label><label>Sensitivity rates<textarea data-soc-v1000-sensitivity-values placeholder="0, 1, 2, 3"></textarea></label></div>
          ...
          <div class="sc-mrv1500" data-mrv-v1500-root>
            <div class="sc-mrv1500__hero"><div><span class="sc-mrv1500__eyebrow">CARBON &amp; NATURE / MRV / v0.15.0</span><h3>MRV Uncertainty &amp; Detection Engine</h3><p>Build explicit uncertainty budgets, quantify whether observed change exceeds a user-specified detection threshold, and plan sample sizes for minimum detectable change without hidden confidence, coverage, or power defaults.</p></div><div class="sc-mrv1500__badges"><span class="sc-mrv1500__badge">Lab v0.98.0</span><span class="sc-mrv1500__badge">Explicit uncertainty budget</span><span class="sc-mrv1500__badge">Paired + independent detection</span></div></div>
            <div class="sc-mrv1500__grid">
              <div class="sc-mrv1500__card"><h4>Assessment identity</h4><div class="sc-mrv1500__fields"><label>Project ID<input data-mrv-v1500-project-id></label><label>Assessment ID<input data-mrv-v1500-assessment-id placeholder="generated when blank"></label><label>Title<input data-mrv-v1500-title></label><label>Metric<input data-mrv-v1500-metric placeholder="SOC stock change"></label><label>Unit<input data-mrv-v1500-unit placeholder="Mg C/ha"></label><label>Monitoring plan reference<input data-mrv-v1500-monitoring-ref></label><label>Protocol reference<input data-mrv-v1500-protocol-ref></label></div><div class="sc-mrv1500__actions"><button type="button" class="sc-lab-button" data-mrv-v1500-example>Load example</button></div></div>
              <div class="sc-mrv1500__card"><h4>Uncertainty budget</h4><div class="sc-mrv1500__fields"><label>Estimate<input type="number" step="any" data-mrv-v1500-estimate></label><label>Coverage factor <small>optional; explicit</small><input type="number" step="any" min="0" data-mrv-v1500-coverage></label></div><label>Components <small>key | standard uncertainty | source ref</small><textarea data-mrv-v1500-components placeholder="sampling | 3 | evidence:sampling&#10;laboratory | 4 | evidence:lab"></textarea></label><div class="sc-mrv1500__actions"><button type="button" class="sc-lab-button sc-lab-button-primary" data-mrv-v1500-budget-calc>Calculate budget</button></div><p>Combined standard uncertainty: <strong data-mrv-v1500-combined-u>—</strong></p><details><summary>Budget record</summary><pre data-mrv-v1500-budget-output>No budget yet.</pre></details></div>
              <div class="sc-mrv1500__card"><h4>Observed-change detection</h4><div class="sc-mrv1500__fields"><label>Design<select data-mrv-v1500-design><option value="paired">Paired</option><option value="independent">Independent</option></select></label><label>Observed change<input type="number" step="any" data-mrv-v1500-change></label><label>Critical value<input type="number" step="any" min="0" data-mrv-v1500-critical placeholder="explicit, e.g. 1.96"></label><label>SD of paired change<input type="number" step="any" min="0" data-mrv-v1500-sd-change></label><label>Paired n<input type="number" step="1" min="2" data-mrv-v1500-n-pairs></label><label>Baseline SD<input type="number" step="any" min="0" data-mrv-v1500-baseline-sd></label><label>Follow-up SD<input type="number" step="any" min="0" data-mrv-v1500-followup-sd></label><label>Baseline n<input type="number" step="1" min="2" data-mrv-v1500-n-baseline></label><label>Follow-up n<input type="number" step="1" min="2" data-mrv-v1500-n-followup></label></div><div class="sc-mrv1500__actions"><button type="button" class="sc-lab-button sc-lab-button-primary" data-mrv-v1500-detect>Evaluate detection</button></div><p>Threshold: <strong data-mrv-v1500-threshold>—</strong> · Detected: <strong data-mrv-v1500-detected>—</strong></p><details><summary>Detection record</summary><pre data-mrv-v1500-detection-output>No detection calculation yet.</pre></details></div>
              <div class="sc-mrv1500__card"><h4>Detection-oriented sample-size planning</h4><div class="sc-mrv1500__fields"><label>Design<select data-mrv-v1500-plan-design><option value="paired">Paired</option><option value="independent-equal">Independent, equal n</option></select></label><label>Minimum detectable change<input type="number" step="any" min="0" data-mrv-v1500-mdd></label><label>Z alpha<input type="number" step="any" min="0" data-mrv-v1500-z-alpha></label><label>Z power<input type="number" step="any" min="0" data-mrv-v1500-z-power></label><label>Expected SD of change<input type="number" step="any" min="0" data-mrv-v1500-plan-sd-change></label><label>Baseline SD<input type="number" step="any" min="0" data-mrv-v1500-plan-baseline-sd></label><label>Follow-up SD<input type="number" step="any" min="0" data-mrv-v1500-plan-followup-sd></label><label><input type="checkbox" data-mrv-v1500-include-planning> Include in assessment</label></div><div class="sc-mrv1500__actions"><button type="button" class="sc-lab-button sc-lab-button-primary" data-mrv-v1500-plan-calc>Calculate planning n</button></div><p>Planning n: <strong data-mrv-v1500-planning-n>—</strong></p><details><summary>Planning record</summary><pre data-mrv-v1500-planning-output>No planning calculation yet.</pre></details></div>
              <div class="sc-mrv1500__card sc-mrv1500__card--wide"><h4>Evidence, review &amp; project handoff</h4><div class="sc-mrv1500__fields"><label>Methodology references<textarea data-mrv-v1500-methodology-refs></textarea></label><label>Source references<textarea data-mrv-v1500-source-refs></textarea></label></div><div class="sc-mrv1500__actions"><button type="button" class="sc-lab-button sc-lab-button-primary" data-mrv-v1500-build>Build assessment</button><button type="button" class="sc-lab-button" data-mrv-v1500-validate>Validate</button><button type="button" class="sc-lab-button" data-mrv-v1500-save>Save to project</button><button type="button" class="sc-lab-button" data-mrv-v1500-packet>Build project packet</button></div><p class="sc-mrv1500__status" data-mrv-v1500-status role="status" aria-live="polite">MRV Uncertainty &amp; Detection Engine ready.</p></div>
              <div class="sc-mrv1500__card"><h4>Assessment readiness</h4><div class="sc-mrv1500__summary"><div class="sc-mrv1500__metric"><small>Assessment</small><strong data-mrv-v1500-state>not built</strong></div><div class="sc-mrv1500__metric"><small>Readiness</small><strong data-mrv-v1500-readiness>not checked</strong></div><div class="sc-mrv1500__metric"><small>Boundary</small><strong>internal review only</strong></div></div><h5>Unresolved items</h5><pre data-mrv-v1500-missing>No validation yet.</pre><details><summary>Validation record</summary><pre data-mrv-v1500-validation-output>No validation yet.</pre></details></div>
              <div class="sc-mrv1500__card"><h4>Assessment record</h4><details open><summary>Built assessment</summary><pre data-mrv-v1500-output>No assessment built yet.</pre></details><details><summary>Carbon Project model-run packet</summary><pre data-mrv-v1500-packet-output>No packet yet.</pre></details></div>
            </div>
          </div>

          <div class="sc-mrv1600" data-mrv-v1600-root>
            <div class="sc-mrv1600__hero"><div><span class="sc-mrv1600__eyebrow">CARBON &amp; NATURE / MRV / v0.16.0</span><h3>Verification Evidence Ledger</h3><p>Assemble auditable MRV evidence, link each item to explicit protocol requirements, preserve internal review state, and build a deterministic hash chain without turning record integrity into a claim of external verification.</p></div><div class="sc-mrv1600__badges"><span class="sc-mrv1600__badge">Lab v0.99.0</span><span class="sc-mrv1600__badge">SHA-256 evidence chain</span><span class="sc-mrv1600__badge">Verification-record handoff</span></div></div>
            <div class="sc-mrv1600__grid">
              <div class="sc-mrv1600__card"><h4>Ledger identity</h4><div class="sc-mrv1600__fields"><label>Project ID<input data-mrv-v1600-project-id></label><label>Ledger ID<input data-mrv-v1600-ledger-id placeholder="generated when blank"></label><label>Title<input data-mrv-v1600-title></label><label>Protocol reference<input data-mrv-v1600-protocol-ref></label><label>Monitoring plan reference<input data-mrv-v1600-monitoring-ref></label><label>Uncertainty assessment reference<input data-mrv-v1600-uncertainty-ref></label></div><div class="sc-mrv1600__actions"><button type="button" class="sc-lab-button" data-mrv-v1600-example>Load example</button></div></div>
              <div class="sc-mrv1600__card"><h4>Explicit evidence requirements</h4><label>One per line <small>key | description | accepted types comma-separated | required/optional</small><textarea data-mrv-v1600-requirements placeholder="sampling-record | Sampling evidence exists | sample-record | required"></textarea></label><p>No evidence requirement is inferred. Carry requirements forward from the governing protocol and monitoring plan.</p></div>
              <div class="sc-mrv1600__card sc-mrv1600__card--wide"><h4>Evidence entries</h4><label>One per line <small>ID | type | source ref | SHA-256 optional | requirement keys comma-separated | internal review state | title</small><textarea data-mrv-v1600-entries placeholder="sample-001 | sample-record | sample:001 | | sampling-record | accepted-for-internal-review | Composite soil sample"></textarea></label><p>Supported entries include observations, samples, chain-of-custody records, lab results, QC, calculations, model runs, monitoring records, protocols, methodology references, documents and images.</p></div>
              <div class="sc-mrv1600__card sc-mrv1600__card--wide"><h4>Provenance &amp; project handoff</h4><div class="sc-mrv1600__fields"><label>Methodology references<textarea data-mrv-v1600-methodology-refs></textarea></label><label>Source references<textarea data-mrv-v1600-source-refs></textarea></label></div><div class="sc-mrv1600__actions"><button type="button" class="sc-lab-button sc-lab-button-primary" data-mrv-v1600-build>Build ledger</button><button type="button" class="sc-lab-button" data-mrv-v1600-validate>Validate</button><button type="button" class="sc-lab-button" data-mrv-v1600-chain-check>Check hash chain</button><button type="button" class="sc-lab-button" data-mrv-v1600-save>Save to project</button><button type="button" class="sc-lab-button" data-mrv-v1600-packet>Build verification-record packet</button></div><p class="sc-mrv1600__status" data-mrv-v1600-status role="status" aria-live="polite">Verification Evidence Ledger ready.</p></div>
              <div class="sc-mrv1600__card"><h4>Ledger readiness</h4><div class="sc-mrv1600__summary"><div class="sc-mrv1600__metric"><small>Ledger</small><strong data-mrv-v1600-state>not built</strong></div><div class="sc-mrv1600__metric"><small>Readiness</small><strong data-mrv-v1600-readiness>not checked</strong></div><div class="sc-mrv1600__metric"><small>Chain</small><strong data-mrv-v1600-chain>not checked</strong></div></div><p>Root hash: <code data-mrv-v1600-root-hash>—</code></p><h5>Unresolved items</h5><pre data-mrv-v1600-missing>No validation yet.</pre><details><summary>Validation record</summary><pre data-mrv-v1600-validation-output>No validation yet.</pre></details><details><summary>Chain check</summary><pre data-mrv-v1600-chain-output>No chain check yet.</pre></details></div>
              <div class="sc-mrv1600__card"><h4>Ledger record</h4><details open><summary>Built ledger</summary><pre data-mrv-v1600-output>No ledger built yet.</pre></details><details><summary>Carbon Project verification-record packet</summary><pre data-mrv-v1600-packet-output>No packet yet.</pre></details></div>
            </div>
          </div>

          <div class="sc-mrv1700" data-mrv-v1700-root>
            <div class="sc-mrv1700__hero"><div><span class="sc-mrv1700__eyebrow">CARBON &amp; NATURE / MRV / v0.17.0</span><h3>MRV Reporting &amp; Audit Packets</h3><p>Assemble a structured MRV report, preserve declared metric lineage, link the protocol, monitoring plan, uncertainty assessment and verification ledger, and package the result for internal audit preparation without claiming external verification or auditor approval.</p></div><div class="sc-mrv1700__badges"><span class="sc-mrv1700__badge">Lab v0.100.0</span><span class="sc-mrv1700__badge">8-section internal report</span><span class="sc-mrv1700__badge">Audit-preparation manifest</span></div></div>
            <div class="sc-mrv1700__grid">
              <div class="sc-mrv1700__card"><h4>Report identity</h4><div class="sc-mrv1700__fields"><label>Report type<select data-mrv-v1700-report-type><option value="monitoring-report">Monitoring report</option><option value="verification-preparation-report">Verification-preparation report</option><option value="project-period-summary">Project-period summary</option></select></label><label>Project ID<input data-mrv-v1700-project-id></label><label>Report ID<input data-mrv-v1700-report-id placeholder="generated when blank"></label><label>Title<input data-mrv-v1700-title></label><label>Period start<input type="date" data-mrv-v1700-period-start></label><label>Period end<input type="date" data-mrv-v1700-period-end></label><label>Prepared by<input data-mrv-v1700-prepared-by></label></div><div class="sc-mrv1700__actions"><button type="button" class="sc-lab-button" data-mrv-v1700-example>Load example</button></div></div>
              <div class="sc-mrv1700__card"><h4>Governed component references</h4><div class="sc-mrv1700__fields"><label>Protocol reference<input data-mrv-v1700-protocol-ref></label><label>Monitoring plan reference<input data-mrv-v1700-monitoring-ref></label><label>Uncertainty assessment reference<input data-mrv-v1700-uncertainty-ref></label><label>Verification ledger reference<input data-mrv-v1700-ledger-ref></label></div><label>Optional full v0.16 verification-ledger JSON<textarea data-mrv-v1700-ledger-json placeholder="Paste a complete Verification Evidence Ledger object to enable chain checking for audit-preparation readiness."></textarea></label></div>
              <div class="sc-mrv1700__card sc-mrv1700__card--wide"><h4>Internal report sections</h4><label>One per line <small>section key | title | content | source refs comma-separated</small><textarea data-mrv-v1700-sections placeholder="project-boundary | Project boundary and reporting period | ... | project:123"></textarea></label><p>Eight Sustainable Catalyst internal sections are expected for internal-review readiness. They are not represented as an external program or methodology template.</p></div>
              <div class="sc-mrv1700__card"><h4>Reported metrics</h4><label>One per line <small>ID | name | value | unit | source ref | uncertainty ref | note</small><textarea data-mrv-v1700-metrics placeholder="soc-change | SOC stock change | 7.8 | Mg C/ha | model-run:soc-change | mrv-uncertainty:123 | carried-forward result"></textarea></label><p>The reporting layer preserves supplied values and lineage. It does not silently recalculate them.</p></div>
              <div class="sc-mrv1700__card"><h4>Deviations &amp; corrective actions</h4><label>One per line <small>ID | description | state | resolution note | source refs comma-separated</small><textarea data-mrv-v1700-deviations placeholder="dev-001 | Laboratory rerun pending | open | | lab:batch-1"></textarea></label><p>Open deviations block internal-report readiness. Resolved items remain visible.</p></div>
              <div class="sc-mrv1700__card sc-mrv1700__card--wide"><h4>Audit-packet artifact index</h4><label>One per line <small>ID | artifact type | source ref | SHA-256 optional | role</small><textarea data-mrv-v1700-artifacts placeholder="lab-result | laboratory-result | lab:001 | &lt;sha256&gt; | supporting evidence"></textarea></label><div class="sc-mrv1700__fields"><label>Methodology references<textarea data-mrv-v1700-methodology-refs></textarea></label><label>Source references<textarea data-mrv-v1700-source-refs></textarea></label></div></div>
              <div class="sc-mrv1700__card sc-mrv1700__card--wide"><h4>Build, validate &amp; hand off</h4><div class="sc-mrv1700__actions"><button type="button" class="sc-lab-button sc-lab-button-primary" data-mrv-v1700-build>Build report</button><button type="button" class="sc-lab-button" data-mrv-v1700-validate>Validate report</button><button type="button" class="sc-lab-button" data-mrv-v1700-audit>Build audit packet</button><button type="button" class="sc-lab-button" data-mrv-v1700-save>Save to project</button><button type="button" class="sc-lab-button" data-mrv-v1700-packet>Build verification-record packet</button></div><p class="sc-mrv1700__status" data-mrv-v1700-status role="status" aria-live="polite">MRV Reporting &amp; Audit Packets ready.</p></div>
              <div class="sc-mrv1700__card"><h4>Readiness</h4><div class="sc-mrv1700__summary"><div class="sc-mrv1700__metric"><small>Report</small><strong data-mrv-v1700-state>not built</strong></div><div class="sc-mrv1700__metric"><small>Review</small><strong data-mrv-v1700-readiness>not checked</strong></div><div class="sc-mrv1700__metric"><small>Ledger chain</small><strong data-mrv-v1700-chain>not checked</strong></div><div class="sc-mrv1700__metric"><small>Audit packet</small><strong data-mrv-v1700-audit-state>not built</strong></div></div><p>Report fingerprint: <code data-mrv-v1700-fingerprint>—</code></p><h5>Unresolved items</h5><pre data-mrv-v1700-missing>No validation yet.</pre><details><summary>Validation record</summary><pre data-mrv-v1700-validation-output>No validation yet.</pre></details></div>
              <div class="sc-mrv1700__card"><h4>Structured records</h4><details open><summary>Built report</summary><pre data-mrv-v1700-output>No report built yet.</pre></details><details><summary>Audit-preparation packet</summary><pre data-mrv-v1700-audit-output>No audit packet yet.</pre></details><details><summary>Carbon Project verification-record packet</summary><pre data-mrv-v1700-packet-output>No project packet yet.</pre></details></div>
            </div>
          </div>
        </div>
        </div>
  ...
  <div data-laboratory-instrumentation-root></div>
    ...
    <div data-instrumentation-validation-custody-root></div>
      ...
      <section class="sc-lab-panel sc-lab-module sc-gs0470" data-lab-module="graph-studio" data-module-panel="graph-studio" hidden>
        <header class="sc-lab-module-header"><p class="sc-lab-kicker">VISUALIZE / GRAPH STUDIO / COMPETING PATHS v0.135.11.0</p><h3>Scientific Visualization Workspace</h3><p>Graph Studio now compares multiple bounded provenance paths between two governed research objects. Researchers can inspect alternative declared relationship chains, switch the active path without rebuilding the graph, review explicitly stored supporting or contradicting edge context, and hand the comparison to Project Workspace without asking the Lab to choose a preferred explanation.</p></header>
        ...
        <div class="sc-gs0470-shell">
          <aside class="sc-gs0470-controls" aria-label="Figure controls">
            <section class="sc-gs0470-card"><h4>Figure definition</h4>
              ...
              <section class="sc-gs0840-gpu" aria-label="GPU renderer architecture controls">
                <div class="sc-gs0840-head"><strong>GPU RENDERER ARCHITECTURE</strong><span>v0.84 · engine 2.11 · capability-gated</span></div>
                <div class="sc-gs0840-grid">
                  <label>Required renderer features <small>comma-separated contract requirements</small><input type="text" value="3d" data-gs-v0840-features></label>
                  <label>Preferred renderers <small>ordered; fallback is always recorded</small><input type="text" value="webgpu,webgl2,canvas3d" data-gs-v0840-preferred></label>
                </div>
                <div class="sc-gs0470-actions"><button type="button" class="sc-lab-button" data-gs-v0840-detect>Detect browser renderer capabilities</button><button type="button" class="sc-lab-button sc-lab-button-primary" data-gs-v0840-negotiate>Negotiate safe renderer</button></div>
                <p class="sc-gs0840-status" data-gs-v0840-status>Awaiting browser capability detection.</p>
                <details><summary>Renderer diagnostics</summary><pre class="sc-gs0840-summary" data-gs-v0840-summary>No renderer diagnostics yet.</pre></details>
                ...
                <p class="sc-gs0840-boundary">v0.84 creates the governed GPU architecture, not the production GPU renderer. WebGL2 and WebGPU capability detection remains explicit; production readiness is determined by the current renderer contracts, never by detection alone. Scientific correctness never depends on GPU availability; any fallback is explicit and recorded. Arbitrary shader source is not accepted.</p>
              </section>
              <section class="sc-gs0850-webgl" aria-label="WebGL2 scientific renderer controls">
                ...
                <p class="sc-gs0850-boundary">v0.85 executes a real WebGL2 production renderer while preserving the scientific figure contract. GPU availability is optional; fallback remains explicit. The renderer does not generate scientific surfaces, interpolate observations, reinterpret data, or execute arbitrary user shader source. Clicking/picking is interaction metadata, not a scientific observation. WebGPU is implemented in v0.87; v0.85 remains the production fallback when WebGPU is unavailable.</p>
              </section>
              <section class="sc-gs0870 sc-gs0870-webgpu" aria-label="WebGPU scientific renderer and GPU compute controls">
                <div><strong>WEBGPU SCIENTIFIC RENDERER &amp; GPU COMPUTE</strong><span> v0.87 · engine 2.13 · production WebGPU with WebGL2 fallback</span></div>
                <div class="sc-gs0870-meta"><span>GPU render pipelines</span><span>GPU filtering</span><span>Histogram + reduction</span><span>Spatial binning</span><span>Approved WGSL only</span></div>
                <canvas class="sc-gs0870-canvas" width="960" height="540" data-gs-v0870-canvas aria-label="WebGPU scientific visualization preview"></canvas>
                <div class="sc-gs0870-actions"><button type="button" class="sc-lab-button" data-gs-v0870-diagnose>Diagnose WebGPU</button><button type="button" class="sc-lab-button sc-lab-button-primary" data-gs-v0870-render>Render WebGPU example</button><button type="button" class="sc-lab-button" data-gs-v0870-compute-btn>Build governed compute pipeline</button></div>
                <p class="sc-gs0870-status" data-gs-v0870-status>Awaiting WebGPU adapter diagnostics.</p>
                <details><summary>WebGPU renderer diagnostics</summary><pre data-gs-v0870-summary>No diagnostics yet.</pre></details>
                <details><summary>GPU compute contract</summary><pre data-gs-v0870-compute>No compute pipeline built.</pre></details>
                <p>v0.87 uses WebGPU only when the browser provides a real adapter/device. WebGL2 remains the explicit production fallback. GPU compute is limited to renderer-owned WGSL kernels and produces derived analytical results, never new observations. Lab does not silently interpolate, impute, forecast, reinterpret scientific semantics, or execute arbitrary WGSL.</p>
              </section>
              <section class="sc-gs0880" aria-label="Advanced 3D Scientific Scene Engine II controls">
                <div class="sc-gs0880__head"><strong>ADVANCED 3D SCIENTIFIC SCENE ENGINE II</strong><span>v0.88 · engine 2.14 · governed scene graphs over WebGPU</span></div>
                <div class="sc-gs0880__meta"><span>Scene graphs</span><span>Cameras + orbit</span><span>Scientific lighting</span><span>GPU instancing</span><span>Mesh / line / points</span><span>Three.js adapter</span></div>
                <canvas class="sc-gs0880__canvas" width="960" height="540" data-gs-v0880-canvas aria-label="Advanced 3D scientific scene preview"></canvas>
                <div class="sc-gs0880__actions"><button type="button" class="sc-lab-button" data-gs-v0880-diagnose>Diagnose Advanced 3D</button><button type="button" class="sc-lab-button sc-lab-button-primary" data-gs-v0880-render>Render native WebGPU scene</button><button type="button" class="sc-lab-button" data-gs-v0880-three>Try Three.js adapter</button><button type="button" class="sc-lab-button" data-gs-v0880-inspect>Inspect governed scene</button></div>
                <p class="sc-gs0880__status" data-gs-v0880-status>Awaiting Advanced 3D diagnostics.</p>
                <details><summary>Advanced 3D diagnostics / render record</summary><pre data-gs-v0880-summary>No Advanced 3D diagnostics yet.</pre></details>
                <details><summary>Governed scene contract</summary><pre data-gs-v0880-scene>Use “Inspect governed scene” to view the normalized scene.</pre></details>
                <p class="sc-gs0880__boundary">v0.88 adds a self-contained native WebGPU 3D scene path plus a Three.js compatibility adapter when a local Three.js runtime is present. Lab never loads Three.js from a CDN automatically. Three.js is not required for scientific correctness. Geometry, topology, normals, units and scientific meaning are never inferred; lighting, materials, orbit/pan/zoom and object interaction are presentation state and cannot create observations.</p>
              </section>
            ...
            <section class="sc-gs0470-card"><h4>Figure actions</h4><p class="sc-lab-data-note">Every saved v0.88 figure preserves its renderer-aware specification and provenance. Renderer capability negotiation is explicit and recorded; GPU availability never changes scientific semantics. Uncertainty layers preserve explicit interval semantics, empirical sample provenance, ensemble-member identity, exact alignment rules, and the authoritative base-figure fingerprint. Scientific markup remains separate from observations. Spatial figures additionally preserve declared CRS, viewport, explicit vector/raster layer fingerprints, nodata policy, and no-reprojection/no-interpolation boundaries. Dataset-bound figures retain transformation/adaptive lineage; 3D scenes retain camera and explicit geometry; 4D state spaces retain source fingerprints, state-axis definitions, projection rotations, observed-state indexes, and no-interpolation boundaries. SVG/PNG/CSV/JSON remain available for 2D; canvas3d and canvas4d use PNG/JSON.</p>
          ...
          <div class="sc-gs0470-workspace">
            ...
            <div data-viz1355-context-root aria-label="Scientific scene linking comparative inspection and context preservation"></div>
            <div data-viz1356-session-root aria-label="Reproducible visual analysis session and interaction lineage"></div>
            <div data-viz1357-narrative-root aria-label="Visual research narrative findings and publication handoff"></div>
            <div data-viz1358-review-root aria-label="Research review critique and revision lineage"></div>
